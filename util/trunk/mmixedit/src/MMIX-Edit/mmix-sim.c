...
/*:11*//*43:*/
#line 1125 "mmix-sim.w"

#include <sys/types.h> 
#include <sys/stat.h> 

/*:43*//*46:*/
#line 1161 "mmix-sim.w"
...
/*:38*//*39:*/
#line 1076 "mmix-sim.w"

typedef char Char;

/*:39*//*54:*/
#line 1272 "mmix-sim.w"
...
/*:48*//*52:*/
#line 1255 "mmix-sim.w"

octa implied_loc;
bool profile_started;

/*:52*//*56:*/
#line 1315 "mmix-sim.w"
...
#line 2454 "mmix-sim.w"

/*:113*//*121:*/
#line 2573 "mmix-sim.w"
...
/*:121*//*129:*/
#line 2682 "mmix-sim.w"

bool showing_stats;
bool just_traced;

/*:129*//*139:*/
#line 2852 "mmix-sim.w"
...
/*:51*/
#line 1231 "mmix-sim.w"
;
if(p->right)print_freqs(p->right);
}

/*:50*//*82:*/
#line 1863 "mmix-sim.w"
...
default:case 1:b= (o.h==0&&o.l==0);break;
...
/*:115*/
#line 2480 "mmix-sim.w"

else/*116:*/
#line 2496 "mmix-sim.w"
...
/*:119*/
#line 2526 "mmix-sim.w"
;
}
}

/*:117*//*120:*/
#line 2554 "mmix-sim.w"
...
/*:62*//*75:*/
#line 1776 "mmix-sim.w"

register int G,L,O;

/*:75*/
#line 2896 "mmix-sim.w"
;
mmix_io_init();
...
;
/*163:*/
#line 3367 "mmix-sim.w"

x.h= 0x40000000,x.l= 0x8;
#line 3377 "mmix-sim.w"
...
breakpoint= false;
if(interacting)/*149:*/
#line 3065 "mmix-sim.w"

{register int repeating;
interact:/*150:*/
#line 3101 "mmix-sim.w"
...
/*:152*/
#line 3077 "mmix-sim.w"
;
/*153:*/
#line 3168 "mmix-sim.w"
...
/*:155*/
#line 3185 "mmix-sim.w"
;break;

/*:153*/
#line 3078 "mmix-sim.w"
;
/*161:*/
#line 3312 "mmix-sim.w"
...
while(repeating)/*156:*/
#line 3224 "mmix-sim.w"

{
if(cur_disp_set)/*157:*/
#line 3235 "mmix-sim.w"
...
/*:149*/
#line 2906 "mmix-sim.w"
;
}
if(halted)break;
do/*60:*/
#line 1356 "mmix-sim.w"

{
if(resuming)loc= incr(inst_ptr,-4),inst= g[rX].l;
else/*63:*/
#line 1411 "mmix-sim.w"
...
/*:70*/
#line 1363 "mmix-sim.w"
;
/*71:*/
#line 1736 "mmix-sim.w"

if(resuming&&rop!=RESUME_AGAIN)
/*126:*/
#line 2636 "mmix-sim.w"
...
/*:100*/
#line 2206 "mmix-sim.w"

else if(xx==rL)/*98:*/
#line 2212 "mmix-sim.w"
...
/*:111*/
#line 2389 "mmix-sim.w"
;
switch(yy){
case Halt:/*109:*/
#line 2405 "mmix-sim.w"
...
;
/*128:*/
#line 2669 "mmix-sim.w"

if(tracing){
if(showing_source&&cur_line)show_line();
/*130:*/
#line 2686 "mmix-sim.w"
