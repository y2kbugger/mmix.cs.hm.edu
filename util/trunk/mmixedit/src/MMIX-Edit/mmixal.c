...
#define dpanic(m,p) {return sprintf(err_buf+1,m,p) ;} \
...
message+1);
addListString(error_message,line_no);
}else if(message[0]=='!'){
...
void assemble ARGS((int,tetra,unsigned int));
...
case outer_rp:case inner_rp:goto scan_close;
