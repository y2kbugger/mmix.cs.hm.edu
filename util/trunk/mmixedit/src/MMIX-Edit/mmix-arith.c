...
/*36:*/
#line 603 "mmix-arith.w"

typedef enum{zro,num,inf,nan}ftype;

/*:36*//*59:*/
#line 1108 "mmix-arith.w"
...
/*:4*//*9:*/
#line 172 "mmix-arith.w"

octa aux;
bool overflow;

/*:9*//*30:*/
#line 462 "mmix-arith.w"
...
/*:14*/
#line 222 "mmix-arith.w"
;
/*15:*/
#line 237 "mmix-arith.w"
...
;
for(j= 3;j>=0;j--)/*20:*/
#line 274 "mmix-arith.w"

{
/*21:*/
#line 282 "mmix-arith.w"
...
/*:33*/
#line 523 "mmix-arith.w"
;
}

/*:31*//*34:*/
#line 549 "mmix-arith.w"
...
/*51:*/
#line 917 "mmix-arith.w"

/*52:*/
#line 932 "mmix-arith.w"
...
/*:51*/
#line 910 "mmix-arith.w"
;
}

/*:50*//*54:*/
#line 970 "mmix-arith.w"
...
/*:63*/
#line 982 "mmix-arith.w"
;
/*64:*/
#line 1221 "mmix-arith.w"

if(e> 0x401)/*65:*/
#line 1252 "mmix-arith.w"
...
/*:74*/
#line 1405 "mmix-arith.w"
;
next_char= p;
exp= 0;
if(*p=='e'&&!NaN)/*77:*/
#line 1448 "mmix-arith.w"
...
;
if(dec_pt)/*78:*/
#line 1461 "mmix-arith.w"

{
/*79:*/
#line 1478 "mmix-arith.w"
...
/*:71*/
#line 1352 "mmix-arith.w"
;
if(strncmp(p,"Inf",3)==0)/*72:*/
#line 1373 "mmix-arith.w"
...
/*:87*/
#line 1624 "mmix-arith.w"
;
}
}

/*:86*//*88:*/
#line 1651 "mmix-arith.w"
...
/*:90*/
#line 1704 "mmix-arith.w"
;
return fpack(z,e,s,r);
}

/*:89*//*91:*/
#line 1719 "mmix-arith.w"
...
case 4*num+num:/*94:*/
#line 1810 "mmix-arith.w"

odd= 0;
thresh= ye-delta;
if(thresh<ze)thresh= ze;
while(ye>=thresh)/*95:*/
#line 1831 "mmix-arith.w"
